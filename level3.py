...
def findSmallLetter(string):

    letter = re.findall(r'[^A-Z]+[A-Z]{3}([a-z])[A-Z]{3}[^A-Z]+', string)
...
words = findSmallLetter(string)
finalWord = ''

if words:
    
    for smallLetters in words:
        
        finalWord = str(smallLetters)
